...
CREATE TABLE IF NOT EXISTS `Quiz`.`Question` (
  ...
  INDEX `fk_Pergunta_Categoria_idx` (`Categoria_idCategorias` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Quiz`.`Quiz` (
  ...
  PRIMARY KEY (`idquiz`),
  INDEX `fk_quiz_Usuario1_idx` (`Usuario_idUsuario` ASC) VISIBLE,
  INDEX `fk_quiz_Ranking1_idx` (`Ranking_idRanking` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Quiz`.`Question_has_Alternative` (
  ...
  INDEX `fk_Pergunta_has_Alternativa_Alternativa1_idx` (`Alternativa_idAlternativas` ASC) VISIBLE,
  INDEX `fk_Pergunta_has_Alternativa_Pergunta1_idx` (`Pergunta_idPergunta` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Quiz`.`Alternative_has_Answer` (
  ...
  INDEX `fk_Alternativa_has_RespostaCerta_RespostaCerta1_idx` (`RespostaCerta_idRespostas` ASC) VISIBLE,
  INDEX `fk_Alternativa_has_RespostaCerta_Alternativa1_idx` (`Alternativa_idAlternativas` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Quiz`.`Quiz_has_Question` (
  ...
  INDEX `fk_quiz_has_Pergunta_Pergunta1_idx` (`Pergunta_idPergunta` ASC) VISIBLE,
  INDEX `fk_quiz_has_Pergunta_quiz1_idx` (`quiz_idquiz` ASC) VISIBLE,
